...
const Bar = () => {
  ...
  const firstChartRender = decodeURI(
    "https://quickchart.io/chart?c=%7B%22type%22%3A%22bar%22%2C%22data%22%3A%7B%22labels%22%3A%5B%22Q1%22%2C%22Q2%22%2C%22Q3%22%2C%22Q4%22%5D%2C%22datasets%22%3A%5B%7B%22data%22%3A%5B230%2C200%2C105%2C160%5D%2C%22label%22%3A%22Coke%22%7D%2C%7B%22data%22%3A%5B140%2C176%2C190%2C165%5D%2C%22label%22%3A%22Pepsi%22%7D%2C%7B%22data%22%3A%5B123%2C243%2C187%2C143%5D%2C%22label%22%3A%22Sprite%22%7D%5D%7D%2C%22options%22%3A%7B%22title%22%3A%7B%22display%22%3Atrue%2C%22text%22%3A%22Soda%20earnings%22%7D%2C%22scales%22%3A%7B%22xAxes%22%3A%5B%7B%22scaleLabel%22%3A%7B%22display%22%3Atrue%2C%22labelString%22%3A%22Quarter%22%7D%7D%5D%2C%22yAxes%22%3A%5B%7B%22scaleLabel%22%3A%7B%22display%22%3Atrue%2C%22labelString%22%3A%22Earnings%20(%24)%22%7D%7D%5D%7D%7D%7D"
  );
  ...
  useEffect(() => {
    ...
    const setTemplate = async () => {
      const x = await generateTemplate("bar");
      setLabels(x[0]);
      setDatasets(x[1]);
  ...
  }, [chartTitle, datasets, labels, templateSet, xAxesLabel, yAxesLabel]);
  ...
  return (
    <div style={{ marginTop: "25px" }}>
      <Helmet>
        ...
        <meta
          name="description"
          content="Generate a basic bar chart with easy to use tools and high quality images. Save the chart as a JPG,PNG, or WEBP file."
        />
      ...
      <div>
        ...
        <Row>
                            ...
                            <DebounceInput
                              ...
                              onChange={(e) => {
                                ...
                                if (isNaN(e.target.value) === true) {
                                  ...
                                  alertTimeout();
                                  var data = [...datasets];
                                  data[index1].data[index2] = 0; //will make bar look like it doesnt render
                                  setDatasets(data);
                                  setRenderChart((x) => x + 1);
                                } else {
                                  //user entered number
          ...
          <Col xl={6} xl="7">
            {chartImg && (
              <>
                <img src={chartImg} className="img-fluid" alt="bar chart" />
